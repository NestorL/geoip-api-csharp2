...
public class LookupService : IDisposable
{
    ...
    //private static int STATE_BEGIN   = 16700000; // Not in use, kept as comment just in case
  ...
  "Saint Barthelemy","Saint Martin", "Bonaire, Saint Eustatius and Saba", "South Sudan", "Other"};
    ...
    protected void refreshdb(String databaseFile)
    {
        lock (ioLock)
        {
            this.close();
    ...
    {
        if (file == null && !((dboptions & GEOIP_MEMORY_CACHE) == 1))
        {
